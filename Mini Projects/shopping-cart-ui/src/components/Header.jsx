            ...
            <div className='p-4'>
              ...
              {cart.length === 0 ? (
                ...
                <>
                  ...
                  <div className='t-4 flex justify-between font-semibold'>
                    <span>Total: </span>
                    <span>${total}</span>
                  </div>
                  ...
                  <button
                    onClick={clearCart}
                    className='mt-3 w-full bg-red-500 text-white py-1 rounded transition cursor-pointer hover:bg-red-600'
                  >Clear Cart</button>
                </>
              )}
            </div>
