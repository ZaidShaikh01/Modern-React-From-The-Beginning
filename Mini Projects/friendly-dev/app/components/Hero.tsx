...
const Hero:React.FC<HeroProps> = ({
  name = 'Zaid',
  text = 'I love devloping working Websites & Apps.',
}) => {
  return (
    <header className='text-center py-20 px-4 bg-gray-900 text-white transition-colors duration-300'>
      ...
      <div className='fex justify-center gap-4'>
        <Link
          to='/projects'
        ...
        <Link
          to={'/contact'}
          className='border border-blue-500 text-blue-400 px-6 py-2 rounded transition hover:bg-blue-600 ml-3 hover:text-white'
        >
          Contact Me
        </Link>
      </div>
