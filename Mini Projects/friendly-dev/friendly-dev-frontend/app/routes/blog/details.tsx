...
const BlogPostDetailsPage = ({ loaderData }: BlogPostDetailsPageProps) => {
  ...
  return (
    <div className='max-w-3xl mx-auto px-6 py-12 bg-gray-900'>
      ...
      />
      <div className='prose prose-inverse text-white max-w-none mb-12'>
        <ReactMarkdown>{post.body}</ReactMarkdown>
      </div>
      <Link
        to='/blog'
        className='inline-block bg-blue-600 text-white rounded-lg px-6 py-2 hover:bg-blue-700 transition'
      >
        Back To Post
      </Link>
    </div>
