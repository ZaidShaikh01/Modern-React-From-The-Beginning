...
- [ ] It comes with built-in frontend templates
...
3.  In Strapi, what is the purpose of creating Content Types?

- [ ] To configure deployment environments
- [ ] To define structured data models like blog posts or products
- [ ] To style frontend components
- [ ] To manage user roles and permissions

Answer: B - To define structured data models like blog posts or products
